  ...
  return (
    <Grid container className={classes.home}>
      ...
      <Grid item className={classes.mainContent} md={10.3}>
        ...
        <Grid item md={12} className={classes.widget}>
          <Grid container spacing={2}>
            <Grid item md={3}><Widget type="Bitcoin"></Widget></Grid>
            <Grid item md={3}><Widget type="Litecoin"></Widget></Grid>
            <Grid item md={3}><Widget type="Ethereum"></Widget></Grid>
            <Grid item md={3}><Widget type="BinanceCoin"></Widget></Grid>
