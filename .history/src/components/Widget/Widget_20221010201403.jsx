...
export default function BasicCard({ type }) {
  ...
  return (
    <Box className={classes.widget}>
      <Box className={classes.cardInfomation}>
        {/* start logo */}
        <Box sx={{ padding: `0`, margin: `0`, height: `40px`, width: `100%` }}>
          <img
            src={data.img}
            alt="anhcoin"
        ...
        {/* start infomation */}
        {/* start BNB to USD */}
        <Box sx={{ display: "inline-flex", padding: `10px 0px 0px 0px` }}>
          <Typography sx={{ fontSize: `16px` }}>{data.coinTitle}</Typography>
        ...
        <CardContent sx={{ padding: `0` }}>
          <Typography sx={{ fontSize: `24px` }}>{data.weirdNumber}</Typography>
        </CardContent>
        {/* end clgt deo biet */}
