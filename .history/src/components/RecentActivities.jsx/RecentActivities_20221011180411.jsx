        ...
        <Box className={classes.box_list}>
          <Grid container className={classes.list} md={12}>
            <Grid item className={classes.listItem} md={12}>
              <Grid item md={2}>
                <img className={claslistItemImg} src={bitcoinSVG} alt="bitcoin" />
              </Grid>
              <Grid item md={2}>
                Bitcoin
              </Grid>
            ...
            <Grid item className={classes.listItem} md={12}>
              <Grid item md={2}>
                <img className={claslistItemImg} src={ethereumSVG} alt="ethereum" />
              </Grid>
              <Grid item md={2}>
                Ethereum
              </Grid>
            ...
            <Grid item className={classes.listItem} md={12}>
              <Grid item md={2}>
                <img className={claslistItemImg} src={litecoinSVG} alt="litecoin" />
              </Grid>
              <Grid item md={2}>
                LTC
              </Grid>
