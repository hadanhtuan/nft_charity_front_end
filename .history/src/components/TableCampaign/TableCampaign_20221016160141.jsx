        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.userId} sx={{ border: 0 }}>
              <TableCell sx={{ b }} align="left">{row.userId}</TableCell>
              <TableCell sx={{ b }} align="center">{row.userName}</TableCell>
              <TableCell sx={{ b }} align="center">{row.totalRides}</TableCell>
              <TableCell sx={{ b }} align="center">{row.totalFinished}</TableCell>
              <TableCell sx={{ b }} align="center">{row.homeLocation}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
