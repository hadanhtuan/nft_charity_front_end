        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.userId} sx={{ border: 0 }}>
              <TableCell s align="left">{row.userId}</TableCell>
              <TableCell s align="center">{row.userName}</TableCell>
              <TableCell s align="center">{row.totalRides}</TableCell>
              <TableCell s align="center">{row.totalFinished}</TableCell>
              <TableCell s align="center">{row.homeLocation}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
