        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.userId} sx={{ border: 0 }}>
              <TableCell sx={{ bord }} align="left">{row.userId}</TableCell>
              <TableCell sx={{ bord }} align="center">{row.userName}</TableCell>
              <TableCell sx={{ bord }} align="center">{row.totalRides}</TableCell>
              <TableCell sx={{ bord }} align="center">{row.totalFinished}</TableCell>
              <TableCell sx={{ bord }} align="center">{row.homeLocation}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
