        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.userId} sx={{ border: 0 }}>
              <TableCell sx={{  }} align="left">{row.userId}</TableCell>
              <TableCell sx={{  }} align="center">{row.userName}</TableCell>
              <TableCell sx={{  }} align="center">{row.totalRides}</TableCell>
              <TableCell sx={{  }} align="center">{row.totalFinished}</TableCell>
              <TableCell sx={{  }} align="center">{row.homeLocation}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
