        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="auto">{row.userPhoneNumber}</TableCell>
              <TableCell align="auto">{row.fat}</TableCell>
              <TableCell align="auto">{row.carbs}</TableCell>
              <TableCell align="auto">{row.protein}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
