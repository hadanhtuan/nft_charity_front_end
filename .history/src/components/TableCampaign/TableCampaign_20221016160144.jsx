        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.userId} sx={{ border: 0 }}>
              <TableCell sx={{ border: }} align="left">{row.userId}</TableCell>
              <TableCell sx={{ border: }} align="center">{row.userName}</TableCell>
              <TableCell sx={{ border: }} align="center">{row.totalRides}</TableCell>
              <TableCell sx={{ border: }} align="center">{row.totalFinished}</TableCell>
              <TableCell sx={{ border: }} align="center">{row.homeLocation}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
