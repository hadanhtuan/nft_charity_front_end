...
const rows = [
  {
    id: 1,    user: "Nguyen Van A",
    totalRides: 10,
    totalFinished: 5,
    homeLocation: "Hanoi",
  },
  {
    id: 2,    user: "Nguyen Van B",
    phone: "0123456789",
    totalRides: 11,
    totalFinished: 6,
    homeLocation: "Hanoi",
